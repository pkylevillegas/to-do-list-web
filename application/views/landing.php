    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1">To-do-list</h1>
                <h3 class="mb-5"><em>A Simple and Awesome App to Organize Your Tasks</em></h3>
                <a class="btn btn-primary btn-xl" href="<?php echo base_url()?>login">Get Started</a>
            </div>
        </header>
